...
## setup
1. copy `/config/config.example.yml` and create a `config.yml` file. then enter your backend port, api key (for viewing past document saves), and ip address of the frontend on prod
